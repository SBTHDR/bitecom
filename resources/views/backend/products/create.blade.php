                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="sub_category_id" id="exampleFormControlSelect12">
                                ...
                                <option value="{{ $subCategory->id }}">{{ $subCategory->sub_category_name_en }}</option>
                                @endforeach
                            </select>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="product_code" class="form-control" id="exampleFormControlInput1">
                        </div>
                        @error('product_code')
                        <p class="form-group col-md-12 mb-4 text-danger">
                            {{ $message }}
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="product_color" class="form-control" id="exampleFormControlInput1">
                        </div>
                        @error('product_color')
                        <p class="form-group col-md-12 mb-4 text-danger">
                            {{ $message }}
                        ...
                        <div class="form-group row">
                            <div class="col-12 col-md-9">
                                <label class="control control-checkbox">Make as Featured Product
                                    <input type="checkbox" name="featured_product" value="1">
