        ...
        <div class="card-body">
            <form method="post" action="{{ route('sub.category.update', $subCategory->id) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="sub_category_name_en" class="form-control" id="exampleFormControlInput1" value="{{ $subCategory->sub_category_name_en }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="sub_category_name_bn" class="form-control" id="exampleFormControlInput1" value="{{ $subCategory->sub_category_name_bn }}">
                </div>
