                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-3">
                                    <ul class="links list-unstyled">
                                        ...
                                        <li><a href="#">{{ $subCategory->sub_category_name_en }}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                                <!-- /.col -->
    ...
    <div class="sidebar-widget product-tag wow fadeInUp">
        ...
        <div class="sidebar-widget-body outer-top-xs">
            <div class="tag-list"> <a class="item" title="Phone" href="category.html">Phone</a> <a class="item active"
                    ...
                    href="category.html">Furniture</a> <a class="item" title="T-shirt" href="category.html">T-shirt</a>
                <a class="item" title="Sweatpants" href="category.html">Sweatpants</a> <a class="item" title="Sneaker"
...
<div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
    ...
    <div id="hero">
        <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
            ...
            <div class="item" style="background-image: url({{ asset('upload/sliders/'.$slider->slider_image) }});">
                            ...
                            <div class="product">
                                <div class="product-image">
                                    <div class="image"> <a href="detail.html"><img
                                                src="{{ asset('upload/products/'.$product->product_thumbnail) }}"
                                                alt=""></a>
                                    </div>
                                    <!-- /.image -->
        ...
        <div class="tab-pane" id="category{{ $category->id }}">
            <div class="product-slider">
                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                    ...
                    @php
                    $productWithCategory = App\Models\Product::where('category_id', $category->id)->orderBy('id',
                    'DESC')->get();
                    @endphp

                    @forelse($productWithCategory as $product)
                    <div class="item item-carousel">
                        <div class="products">
                            <div class="product">
                                <div class="product-image">
